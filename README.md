...
8. In order to install desired package just type *pip install desired_package* (e.g. *pip install Flask*)
9. Index of available packages can be found at: https://pypi.python.org/pypi/
